    ...
    <ul class="nav user-menu">
      ...
      <li class="nav-item dropdown has-arrow flag-nav">
        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
          <img src="~assets/img/icons/us1.png" alt="" height="20">
        </a>
        <div class="dropdown-menu dropdown-menu-right">
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="~assets/img/icons/us.png" alt="" height="16"> English </a>
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="~assets/img/icons/fr.png" alt="" height="16"> French </a>
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="~assets/img/icons/de.png" alt="" height="16"> Spanish </a>
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="~assets/img/icons/es.png" alt="" height="16"> German </a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown has-arrow main-drop">
        ...
        <div class="dropdown-menu menu-drop-user">
          <div class="profilename">
            ...
            <hr class="m-0">
            <nuxt-link to="/login" class="dropdown-item logout pb-0">
              <img src="~assets/img/icons/log-out.svg" class="me-2" alt="img">Logout </nuxt-link>
          </div>
        </div>
      </li>
    </ul>
